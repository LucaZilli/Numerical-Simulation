...
template <typename T> void Print_matrix ( const char* filename , const vector< vector<T> >& v, int riga ) {
...
template <typename T> double CalcolaMedia_R( const vector< vector<T> >& v ) {
