...
int main(){ 
    ...
    for(int istep=1; istep <= nstep; ++istep){
        ...
        //cout<<endl<<"xold[0]="<<xold[4]<<"  xold[0]="<<yold[4]<<"  xold[0]="<<zold[4];
        //cout<<endl<<"x[1]="<<x[1]<<"  y[1]="<<y[1]<<"  z[1]="<<z[1];
...
//Read initial configuration
    ...
    if(!m_BOOL){
        ...
        cout << "Prepare velocities as mean velocity between xold and the current x " << endl << endl;
        for (int i=0; i<npart; ++i){
