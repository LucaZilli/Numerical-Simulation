...
int main(){ 
    ...
    Print ( "data_epot.out" , data_epot );
    Print ( "data_etot.out" , data_etot );
    Print ( "data_ekin.out" , data_ekin );
    Print ( "data_temp.out" , data_temp );
...
void Measure(){ //Properties measurement
    ...
    data_epot.push_back(stima_pot);
    stima_kin = t/(double)npart; //Kinetic energy per particle
    data_ekin.push_back(stima_kin);
    stima_temp = (2.0 / 3.0) * t/(double)npart; //Temperature
    data_temp.push_back(stima_temp);
    stima_etot = (t+v)/(double)npart; //Total energy per particle
    data_etot.push_back(stima_etot);
