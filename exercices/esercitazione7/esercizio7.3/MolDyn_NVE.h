...
vector < vector <double> > data_g(1, vector<double> (1000, 0.));
vector < vector <double> > ave_g;
vector < vector <double> > av2_g;
vector < vector <double> > ave_g_prog;
vector < vector <double> > av2_g_prog;
vector < vector <double> > err_g_prog;
